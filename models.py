...
class DrugGNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        # self.conv3 = GATv2Conv(in_channels=512, out_channels=64, heads=8, concat=True, edge_dim=7)
...
class TargetGNN(nn.Module):
    def __init__(self):
        ...
        # self.conv3 = GATv2Conv(in_channels=2560, out_channels=320, heads=8, concat=True, edge_dim=1)
